...
lbTitle = tk.Label(frmMainRight, text="Browsing/Editing",width = 100,relief=tk.SUNKEN, borderwidth = 2,justify = tk.RIGHT)
...
btnChoose12 = tk.Button(frm10, text="Choose",width=8)
...
btnChoose03 = tk.Button(frmC03, text="Choose")
...
btnChooseOp21 = tk.Button(frmOp21, text="Choose")
...
btnChooseOp22 = tk.Button(frmOp22, text="Choose")
